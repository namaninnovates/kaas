...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-32 text-white section-fade">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          <span className="inline-block px-4 py-1.5 rounded-full text-xs font-semibold bg-[#C19A20]/20 text-[#E2B938] border border-[#C19A20]/30 mb-4">Get In Touch</span>
          <h2 className="text-4xl lg:text-5xl font-black tracking-tighter leading-tight premium-heading text-white">Ready to <span className="animate-shimmer">Get Started?</span></h2>
          ...
          <div className="glass rounded-3xl p-8">
            {submitted ? (
              <div className="h-full flex flex-col items-center justify-center gap-4 py-12 text-center">
                ...
                <p className="text-white/60">We'll reach you within 24 hours.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <select id="fproduct" required className="w-full px-4 py-3 rounded-xl border border-[#C19A20]/20 bg-white/10 text-sm focus:outline-none focus:ring-2 focus:ring-[#C19A20]/50 transition-all text-white/70">
