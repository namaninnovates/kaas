...
function TestimonialCard({ t }: { t: typeof allTestimonials[0] }) {
  return (
    <div className="rounded-3xl p-8 flex flex-col gap-6 w-full shadow-xl transition-all duration-300" style={{background: "linear-gradient(135deg, #26104A, #3D1A6B)", border: "1px solid rgba(255,255,255,0.1)"}}>
      <Quote className="w-10 h-10 text-[#C19A20] opacity-50 rotate-180" />
      <p className="text-base text-white/85 leading-relaxed italic">"{t.text}"</p>
...
export default function Testimonials() {
  return (
    <section id="testimonials" className="py-32 overflow-hidden bg-white">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
        ...
        <div className="lg:col-span-5 flex flex-col items-start z-10 relative">
          <span className="inline-block px-4 py-1.5 rounded-full text-xs font-semibold bg-[#26104A]/10 text-[#26104A] border border-[#26104A]/20 mb-6">
            Success Stories
          </span>
          <h2 className="text-5xl lg:text-6xl font-black tracking-tighter leading-tight premium-heading mb-6 text-[#130726]">
            Straight from Those Who Chose <span className="text-[#C19A20]">KAAS</span>
          </h2>
          <p className="text-lg text-[#130726]/60 leading-relaxed mb-10">
        ...
        <div className="lg:col-span-7 h-[700px] relative w-full overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-full w-full">
            
            {/* Column 1: Scrolls UP */}
            <div className="overflow-hidden relative h-full w-full" style={{
              maskImage: "linear-gradient(to bottom, transparent 0%, black 6%, black 94%, transparent 100%)",
              WebkitMaskImage: "linear-gradient(to bottom, transparent 0%, black 6%, black 94%, transparent 100%)"
            }}>
              <div className="flex flex-col gap-6 animate-marquee-vertical-slow w-full">
                {[...col1, ...col1].map((t, i) => (
            ...
            <div className="hidden md:block overflow-hidden relative h-full w-full" style={{
              maskImage: "linear-gradient(to bottom, transparent 0%, black 6%, black 94%, transparent 100%)",
              WebkitMaskImage: "linear-gradient(to bottom, transparent 0%, black 6%, black 94%, transparent 100%)"
            }}>
              <div className="flex flex-col gap-6 animate-marquee-vertical-reverse w-full">
                {[...col2, ...col2].map((t, i) => (
