...
export default function Hero() {
  ...
  return (
    <section id="home" ref={heroContentRef} className="relative min-h-screen flex items-center overflow-hidden pt-32 pb-24 bg-gradient-to-br from-[#1E0B3B] via-[#2D1B69] to-[#3B125C] text-white">
      {/* BG blobs */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] rounded-full bg-[#8B7CC8] opacity-20 blur-3xl -z-10 translate-x-1/3 -translate-y-1/4" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] rounded-full bg-[#C9A84C] opacity-10 blur-3xl -z-10 -translate-x-1/3 translate-y-1/4" />
      <div className="absolute top-1/2 left-1/2 w-[300px] h-[300px] rounded-full bg-[#C4B5E8] opacity-10 blur-2xl -z-10 -translate-x-1/2 -translate-y-1/2" />

      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center w-full">
        {/* Left */}
        <div className="hero-content-wrapper">
          <div className="hero-badge inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/10 border border-white/20 text-xs font-bold text-[#F0CC6E] mb-8 tracking-wide">
          ...
          <div className="hero-ctas flex flex-wrap gap-5 mb-12">
            <a href="#contact" className="px-12 py-5 rounded-full text-[#120E22] font-black bg-[#F0CC6E] shadow-2xl shadow-[#C9A84C]/30 hover:scale-105 transition-all duration-300 flex items-center gap-2">
              Get Started <ChevronRight className="w-5 h-5" />
            </a>
            <a href="#calculator" className="px-12 py-5 rounded-full font-black border-2 border-white/20 text-white hover:border-[#F0CC6E] hover:text-[#F0CC6E] transition-all duration-300 bg-white/5 backdrop-blur-sm">
              Try Calculator
            </a>
          </div>
          ...
          <div className="hero-stats flex flex-wrap gap-12 mt-12">
            <div>
              <div className="flex items-end gap-1">
                ...
                <span className="text-2xl font-bold text-[#F0CC6E]">+</span>
              </div>
            ...
            <div>
              <div className="flex items-end gap-1">
                ...
                <span className="text-2xl font-bold text-[#F0CC6E]">Cr+</span>
              </div>
        ...
        <div className="relative flex justify-center items-center h-[600px]">
          {/* Phone */}
          <div ref={phoneRef} className="relative w-64 h-[480px] rounded-[3rem] gold-gradient p-1 shadow-2xl shadow-[#C9A84C]/30 animate-float z-10">
            <div className="w-full h-full rounded-[2.8rem] bg-[#FDFAF4] flex flex-col items-center p-6 gap-5">
              <div className="w-16 h-1.5 rounded-full bg-[#1E1A2E]/20 mt-1" />
              <p className="text-xs font-bold text-[#8B7CC8] mt-2 tracking-widest uppercase">KAAS Mobile</p>
              <div className="w-full rounded-2xl bg-gradient-to-br from-[#1E1A2E] to-[#3D3560] p-4 text-white">
                ...
                <div className="mt-3 w-full h-1.5 rounded-full bg-white/20">
                  <div className="w-3/4 h-full rounded-full bg-[#C9A84C]" />
                </div>
              ...
              <div className="grid grid-cols-3 gap-3 w-full mt-2">
                {[
                  ...
                  <div key={a.label} className="flex flex-col items-center gap-2 p-3 rounded-2xl bg-[#E8E3F8] transition-transform hover:scale-105 cursor-pointer">
                    <span className="text-[#8B7CC8]">{a.icon}</span>
                    <span className="text-[10px] font-bold text-[#8B7CC8]">{a.label}</span>
                  </div>
                ))}
              </div>
              <div className="w-full rounded-xl bg-[#C9A84C]/10 p-3 border border-[#C9A84C]/20">
                <p className="text-[9px] text-[#A07830] font-semibold">NEXT EMI</p>
                <p className="text-sm font-bold text-[#1E1A2E] mt-0.5">₹ 8,547 <span className="text-[10px] text-green-500 font-medium">✓ On Time</span></p>
              </div>
            </div>
          </div>
          ...
          <div className="absolute top-12 -left-8 glass rounded-[2rem] p-4 flex items-center gap-4 shadow-xl animate-float-delay min-w-[180px] border border-white/30">
            <div className="w-10 h-10 rounded-xl bg-[#C9A84C]/10 flex items-center justify-center text-[#C9A84C]"><Zap className="w-6 h-6" /></div>
            <div><p className="text-sm font-bold text-[#1E1A2E]">Instant Approval</p><p className="text-[11px] text-[#1E1A2E]/70">Under 60 seconds</p></div>
          </div>
          <div className="absolute bottom-24 -left-12 glass-gold rounded-[2rem] p-4 flex items-center gap-4 shadow-xl min-w-[180px] border border-white/20" style={{animation:"float 4s ease-in-out infinite 0.8s"}}>
            <div className="w-10 h-10 rounded-xl bg-[#C9A84C] flex items-center justify-center text-white"><Leaf className="w-6 h-6" /></div>
          ...
          <div className="absolute top-16 -right-8 glass rounded-[2rem] p-4 flex items-center gap-4 shadow-xl min-w-[180px] border border-white/30" style={{animation:"float 4s ease-in-out infinite 1.2s"}}>
            <div className="w-10 h-10 rounded-xl bg-[#C9A84C]/10 flex items-center justify-center text-[#C9A84C]"><Lock className="w-6 h-6" /></div>
            <div><p className="text-sm font-bold text-[#1E1A2E]">Secure</p><p className="text-[11px] text-[#1E1A2E]/70">256-bit encrypted</p></div>
          </div>
          <div className="absolute bottom-12 -right-4 glass-gold rounded-[2rem] p-4 flex items-center gap-4 shadow-xl min-w-[170px] border border-white/20" style={{animation:"float 4s ease-in-out infinite 2s"}}>
            <div className="w-10 h-10 rounded-xl bg-[#C9A84C] flex items-center justify-center text-white"><TrendingUp className="w-6 h-6" /></div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-40">
        ...
        <div className="w-1 h-6 rounded-full bg-[#C9A84C] animate-bounce" />
      </div>
    </section>
  );
}
